      ...
      "user": {
        "about": {
          ...
          "avatar": {
            ...
            "url": "https://portfolio-image-store.s3.ap-south-1.amazonaws.com/1706283290608-n4hq7k"
          },
          "alternateAvatars": [
            {
              "public_id": "portfolio3/1711525564606-1j950d.webp",
              "url": "https://portfolio-image-store.s3.ap-south-1.amazonaws.com/portfolio3/1711525564606-1j950d.webp"
            }
          ]
        },
        ...
        "updatedAt": "2024-03-28T17:38:58.753Z",
        "__v": 73
      }
    }
    )
...
if(showApp)
  ...
  return (
    <>
      <ReactLenis root>
        ...
        <Skills skillsData={data?.user?.skills}/>
        <ProjectSection projects={data?.user?.projects}/>
        <TabsDemo timeline={data?.user?.timeline}/>
        <InfiniteMovingCardsDemo testimonials={data?.user?.testimonials}/>
        <Footer about={data?.user.about} socialHandles={data?.user?.social_handles} />
      </ReactLenis>
    </>
  );
  else return <>
 ...
 <div role="status" className="flex flex-col items-center">
    ...
    <p className="my-2 opacity-50">Loading...</p>
</div>
